...
(function () {
  ...
  var FIELDS = [
    ...
    { key: 'utsaId', label: 'UTSA ID', type: 'text', width: 'half',
      placeholder: 'ABC123', hint: 'UTSA students only, so we can track and reach you directly. Leave blank if you are not a UTSA student.' },
